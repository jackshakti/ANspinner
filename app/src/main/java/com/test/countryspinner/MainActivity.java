package com.test.countryspinner;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void populateSpinner() {
        try {
            jsonCountryArray = new JSONObject(loadJSONFromAsset()).optJSONArray("district");
            ...
            countrySpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    final JSONArray jsonStateArray = jsonCountryArray.optJSONObject(position).optJSONArray("tehsil");
                    ...
                    stateSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        ...
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            final JSONArray jsonCityArray = jsonStateArray.optJSONObject(position).optJSONArray("village");
    ...
    public void submit(View view) {
        ...
        //
        Toast.makeText(getApplicationContext(),"dist "+countrySpinner.getSelectedItem().toString(),Toast.LENGTH_SHORT).show();
        Toast.makeText(getApplicationContext(),"tasil "+stateSpinner.getSelectedItem().toString(),Toast.LENGTH_SHORT).show();
        Toast.makeText(getApplicationContext(),"vill "+citySpinner.getSelectedItem().toString(),Toast.LENGTH_SHORT).show();
